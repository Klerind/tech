...
<div class="container">
 <div class="row">
  <div class="col-md-12">
    ...
    <?php endif; ?>
    <?php if(count($fields['field_group_post']) != 0): ?>
      <p>Add a new post</p>
      <form action="/post/create" method="post"><?php echo csrf_field(); ?>
      <input type="hidden" name="field_group" value=
       ...
       <?php $__currentLoopData = $fields['field_group_post']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $field): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="form-outline mb-4">
          <input type="<?php echo e($field->fieldType->type); ?>" class="form-control form-control-lg" name="<?php echo e($field->field_id); ?>" />
          <label class="form-label" for="form3Example1cg"><?php echo e($field->field->name); ?></label>
        </div>
...
<?php foreach ($contents as $key => $content): ?>
  ...
  <?php foreach ($content as $item): ?>
    <div>
      <?php if ($item->field->name == 'picture'): ?>
        ...
        <?php echo '<img width="300" src="'. $imageUrl .'" alt="image"> '; ?>
 ...
 <?php endforeach; ?>
   <span>
      <b>added by: </b><?php echo $content[$first_key_from_posts_item]->user->name; ?>
    ...
    <?php foreach ($content[$first_key_from_posts_item]->comment as $comment): ?>
      ...
      <b>Added by: </b><?php echo $comment->user->name; ?>
      <b>Added: </b><?php echo $comment->created_at->diffForHumans().'<br>'; ?>
    <?php endforeach; ?>
   </span>
   <form action="/comments/add" method="post"><?php echo csrf_field(); ?>
...
<?php /**PATH /var/www/html/laravel_blog000/resources/views/pages/welcome.blade.php ENDPATH**/ ?>