   ...
   <?php if (!empty($all_contents)): ?>
     <?php foreach ($all_contents as $all_content): ?>
         <?php $first_key_from_content = array_key_first($all_content->toArray()); ?>
           ...
           <?php else: ?>
             <?php echo $value->field->name.': '. $value->content.'<br>'; ?>
           <?php endif; ?>
       <?php endforeach;?>
         <b>added by: </b><?php echo $all_content[$first_key_from_content]->user->name; ?>
         <b>added: </b><?php echo $all_content[$first_key_from_content]['created_at']->diffForHumans().'</br>'; ?>
         ...
         <?php foreach ($all_content[$first_key_from_content]->comment as $comment): ?>
...
unset($__errorArgs, $__bag); ?>
          <input type="hidden" name="content_link" value="<?php echo $all_content[$first_key_from_content]->content_link; ?>" />
...
<?php /**PATH /var/www/html/laravel_blog000/resources/views/pages/search.blade.php ENDPATH**/ ?>